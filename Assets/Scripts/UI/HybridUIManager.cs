...
public class HybridUIManager : MonoBehaviour
{
    ...
    public void StartGame()
    {
        ...
        // Activate the scene-level board (tiles generated by BoardUIGenerator under this transform)
    ...
    public void HideAndCleanup()
    {
        ...
        // Deactivate the scene-level board
        if (hybridBoardParent != null)
    ...
    #region Rule-Driven Panel Configuration
